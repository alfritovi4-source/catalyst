    ...
    <>
      ...
      <Section id="zakon-kontura" number={1} title={law.title} lead={law.gloss}>
        ...
        <Prose className="mt-10">
          <p>
            Свобода выбора — только в отношении себя: тело, сознание, восприятие, здоровье,
            жизнь. Не в отношении Эвереста, Земли, атома или другого человека. Ты можешь делать с
            собой всё; с миром — только то, что не сужает чужих вариантов. Это и есть{" "}
