...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 overflow-visible border-b border-border/70 bg-background/80 backdrop-blur supports-backdrop-filter:bg-background/65">
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center gap-4 overflow-visible px-4 sm:px-6 lg:px-8">
        <Link
          href="/"
        ...
        <div className="ml-auto md:ml-2 xl:hidden">
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="right" className="overflow-y-auto">
              ...
              <nav aria-label="Меню" className="flex flex-col gap-1 px-2 pb-6">
                {primaryNav.map((item) => (
                  <Link
                    key={item.href}
                    href={item.href}
